...
function fadeIn(fadeLength) {
    return new actions_effect_leveled_FadeIn.FadeInEffectAction('fade', fadeLength);
}
/**
 * @summary action
 * @description
...
function fadeOut(fadeLength) {
    return new actions_effect_leveled_FadeOut.FadeoutEffectAction('fade', -fadeLength);
}
/**
 * @summary action
 * @description
